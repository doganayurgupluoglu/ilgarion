<?php
// forum/index.php - Tüm kategorileri görme yetkisi ile güncellenmiş
...
<div class="forum-page-container">
    ...
    <div class="forum-header">
        ...
        <div class="forum-actions">
            <!-- Arama Çubuğu -->
            <form class="forum-search" method="GET" action="/forum/search.php">
                <div class="search-input-group">
                    <input type="text" name="q" placeholder="Forumda ara..." class="search-input" required>
            ...
            <?php if ($is_approved && !empty($categories)): ?>
                <a href="create_topic.php" class="btn-new-topic">
                        ...
                        <?php if ($category['last_topic_title']): ?>
                            <div class="latest-topic">
                                <div class="latest-title">
                                    <a href="topic.php?id=<?= $category['last_topic_id'] ?>">
                ...
                <?php if (!$is_logged_in): ?>
                    <div class="forum-welcome-card">
                        ...
                        <div class="welcome-actions">
                            ...
                            <a href="register.php?mode=login" class="btn-secondary">
                                <i class="fas fa-sign-in-alt"></i> Giriş Yap
                            </a>
                        </div>
                    </div>
