...
async function editPost(postId, type) {
    try {
        ...
        if (type === 'topic') {
            ...
            url = `/forum/actions/get_post_content.php?type=topic&topic_id=${topicId}`;
        } else {
            // Normal post düzenleme
            url = `/forum/actions/get_post_content.php?post_id=${postId}&type=post`;
        }
...
async function handleEditSubmit(e) {
    ...
    try {
        ...
        const response = await fetch('/forum/actions/edit_post.php', {
            method: 'POST',
            body: formData
        });
...
async function toggleTopicLike(topicId) {
    ...
    try {
        const response = await fetch('/forum/actions/toggle_topic_like.php', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/x-www-form-urlencoded',
            },
