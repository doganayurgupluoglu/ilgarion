...
<main class="main-content">
        ...
        <div class="hero-left">
            ...
            <div class="hero-links">
                ...
                <?php elseif ($can_create_content): ?>
                    <!-- <a href="<?php echo get_auth_base_url(); ?>/admin/index.php" class="btn btn-hero-action">
    ...
    <section class="recent-events-section">
        <div class="section-header">
            ...
            <a href="<?php echo get_auth_base_url(); ?>/events.php" class="section-link">Tümünü Gör</a>
        </div>
            ...
            <?php foreach ($recent_events as $event): ?>
                <div class="event-card">
                    ...
                    <h3 class="event-title">
                        <a href="<?php echo get_auth_base_url(); ?>/event_detail.php?id=<?php echo $event['id']; ?>">
        ...
        <?php if (!$is_logged_in): ?>
            <div class="guest-notice">
                <p><i class="fas fa-info-circle"></i> 
                   ...
                   <a href="<?php echo get_auth_base_url(); ?>/login.php">giriş yapın</a> 
                   veya <a href="<?php echo get_auth_base_url(); ?>/register.php">üye olun</a>.
                </p>
            </div>
        <?php endif; ?>
    ...
    <section class="recent-gallery-section">
        <div class="section-header">
            ...
            <a href="<?php echo get_auth_base_url(); ?>/gallery.php" class="section-link">Galeriyi Gör</a>
        </div>
        <div class="gallery-grid">
            <?php foreach ($recent_photos as $photo): ?>
                <div class="gallery-item">
                    <a href="<?php echo get_auth_base_url(); ?>/gallery.php#photo-<?php echo $photo['id']; ?>">
    ...
    <section class="recent-discussions-section">
        <div class="section-header">
            ...
            <a href="<?php echo get_auth_base_url(); ?>/discussions.php" class="section-link">Tümünü Gör</a>
        </div>
                ...
                <div class="discussion-item">
                    <div class="discussion-content">
                        <h4 class="discussion-title">
                            <a href="<?php echo get_auth_base_url(); ?>/discussion_detail.php?id=<?php echo $discussion['id']; ?>">
    ...
    <section class="quick-actions-section">
        ...
        <div class="quick-actions-grid">
            <?php if (has_permission($pdo, 'event.create')): ?>
                <a href="<?php echo get_auth_base_url(); ?>/create_event.php" class="quick-action-card">
            ...
            <?php if (has_permission($pdo, 'guide.create')): ?>
                <a href="<?php echo get_auth_base_url(); ?>/new_guide.php" class="quick-action-card">
            ...
            <?php if (has_permission($pdo, 'gallery.upload')): ?>
                <a href="<?php echo get_auth_base_url(); ?>/upload_photo.php" class="quick-action-card">
            ...
            <?php if (has_permission($pdo, 'discussion.topic.create')): ?>
                <a href="<?php echo get_auth_base_url(); ?>/create_topic.php" class="quick-action-card">
                    <i class="fas fa-comment-alt"></i>
                    <span>Tartışma Başlat</span>
                </a>
            <?php endif; ?>
            
            <a href="<?php echo get_auth_base_url(); ?>/edit_profile.php" class="quick-action-card">
                <i class="fas fa-user-edit"></i>
                <span>Profili Düzenle</span>
            </a>
            
            <a href="<?php echo get_auth_base_url(); ?>/edit_hangar.php" class="quick-action-card">
